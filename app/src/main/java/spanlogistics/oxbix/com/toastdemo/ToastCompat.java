...
public class ToastCompat implements IToast {
    ...
    ToastCompat(Context context, String text, int duration) {
        if(Build.VERSION.SDK_INT>Build.VERSION_CODES.KITKAT){
            ...
            checkNotification = notificationEnabled ? 0 : 1;
    ...
    public static IToast makeText(Context context, String text, int duration) {
        ...
        View mView = View.inflate(context,R.layout.item_custom_toast, null);
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        mView.setLayoutParams(params);
        TextView mTvContent = (TextView) mView.findViewById(R.id.id_toast_text);
